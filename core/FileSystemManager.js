                ...
                children: {
                  'Desktop': {
                    ...
                    children: {
                      'Welcome.txt': {
                        type: 'file',
                        content: 'Welcome to RetroOS Engine Creator Demo!\n\nThis build is a creation platform for retro-native interactive games:\n- Desktop shell + app framework for in-world game interfaces\n- RetroScript events for ARG progression, puzzles, and triggers\n- Multimedia pipeline for analog horror tapes, audio logs, and cutscenes\n- Modular features/plugins for rapidly prototyping new mechanics\n\nCreator Quick Tour:\n1. Open Help > Creator Showcase\n2. Launch Script Runner and run a RetroScript scenario\n3. Explore Media Player + Video Player for story media playback\n4. Use Terminal + filesystem files for clues, logs, and branching content\n\nBuild once, then iterate quickly on retro gaming experiences.',
                        extension: 'txt',
                        size: 250,
                        created: new Date('2024-01-01').toISOString(),
                        modified: new Date('2024-01-01').toISOString()
                  ...
                  'Documents': {
                    ...
                    children: {
                      ...
                      'welcome.txt': {
                        type: 'file',
                        content: 'Welcome to the RetroOS Engine creator workspace.\n\nUse this folder as your game design kit:\n- Stage ARG breadcrumbs in text files, mail, and hidden directories\n- Drive encounters with RetroScript events, timers, and app launches\n- Blend media clues with in-world tools (Terminal, Notepad, Browser)\n\nThis platform is built for retro gamers creating interactive narrative experiences.',
                        extension: 'txt',
                        size: 165,
                        created: new Date('2024-01-01').toISOString(),
                        modified: new Date('2024-01-01').toISOString()
